...
class Paket extends Destination {
    ...
    public function __construct($id, $nama_destinasi, $deskripsi_destinasi, $lokasi, $htm, $image, $created_at, $updated_at,
                                $nama_paket, $deskripsi, $harga_total, $hotel_id, $transport_id, $rating = 0, $ulasan = 0, $total_pembelian = 0) {
    ...
    public function hitungHargaTotal($hargaTransport, $hargaHotel) {
        $this->harga_total = $this->htm + $hargaTransport + $hargaHotel;
